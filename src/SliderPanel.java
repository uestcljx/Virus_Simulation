...
//                    break;
                ...
                case "MORTALITYNoBed":
                    ...
                    Constants.MORTALITYNoBed = fRate;
                case "MORTALITY":
                    float ffRate = (float) source.getValue()/100;
                    System.out.println(ffRate);
                    Constants.MORTALITY = ffRate;
            }
//            textField.setText("" + source.getValue());
        ...
        slider.setValue(Constants.BED_COUNT);
...
//        addSlider(slider, "潜伏时间","SHADOW_TIME");
        ...
        slider.setValue((int)(10*Constants.BROAD_RATE));
        ...
        slider.setMinorTickSpacing(5);
        slider.setValue((int)(100 * Constants.MORTALITYNoBed));
        addSlider(slider, "未隔离病死率","MORTALITYNoBed");
        ...
        slider.setMajorTickSpacing(10);
        slider.setMinorTickSpacing(5);
        slider.setValue((int)(100 * Constants.MORTALITY));
        addSlider(slider, "隔离病死率","MORTALITY");
